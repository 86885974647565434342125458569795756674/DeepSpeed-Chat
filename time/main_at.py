...
def main():
    ...
    '''with torch.profiler.profile(
            ...
            on_trace_ready=torch.profiler.tensorboard_trace_handler(args.tensorboard_web),
            record_shapes=True,
            profile_memory=True,
            with_stack=True
    ) as prof:'''
...
#        prof.step()
        ...
        for step, (batch_prompt, batch_unsupervised) in enumerate(
            ...
            #cyy
             ...
             #   handle = pre_pdb(args.local_rank,16000)
              #  pdb.Pdb(stdin=handle,stdout=handle).set_trace()
            if args.generation_batches==step:
                break
           ...
           #             if args.local_rank==0:
            #                print("cyy_i{}".format(i))
                        ...
                        if args.local_rank==0:
                            ...
                            print("cyy_at", start.elapsed_time(end))
                        else:
                            _,_=trainer.train_rlhf(exp_data)
